...
var BannerHome = {
    ...
    eventListener: function eventListener() {
        BannerHome.flechas.on('click', function (e) {
            var IndiceNuevo = BannerHome.indiceActual + 1;
    ...
    MostrarBannerPorIndice: function MostrarBannerPorIndice(index) {
        ...
        var siguiente = (0, _jquery2.default)(BannerHome.slides[indiceLimpio]); //$('.Galeria--BannerHome--slide[data-indice="' + indiceLimpio + '"]');
     ...
     * @constructor
     */
    LimpiarIndice: function LimpiarIndice(index) {
        var indiceLimpio = parseInt(index);
        if (indiceLimpio < 0) {
...
var _BannerHome = require('./helpers/BannerHome');
