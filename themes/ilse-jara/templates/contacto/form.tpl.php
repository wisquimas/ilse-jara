<div class="Contacto">
    <div class="Contacto--selector">
        ...
        <div class="Contacto--selector--select">CONSULTAS</div>
        <div class="Contacto--selector--select">RELACIONES INTERNACIONALES VENTAS</div>
        <div class="Contacto--selector--select">MARKETING</div>
        <div class="Contacto--selector--select">TRABAJE CON NOSOTROS</div>
    </div>
    <div class="Contacto--ventana--body">
        <div class="Contacto--ventana">
            ...
            <form action="" class="Contacto--form">
                ...
                <div class="Contacto--form--label Contacto--form--label--telefono">
                ...
                <div class="clear"></div>
                <textarea name="texto" id="" cols="30" rows="10" class="Contacto--form--textarea"></textarea>
